...
public class Tags 
	...
	final static String thisClass = "org.jldupont.delicious.Tags";
	...
	private void setup() {
		setRecyclable();
		this.jscb = new JSONcallback("attached_to_delicious_tags");
	 ...
	 * CALLBACK
	 ===================================================================*/
	public static void callback(int id, JavaScriptObject obj) {
	...
	protected native void createCallback(int id) /*-{
		...
		obj.handler = function(jsonobj) {
			@org.jldupont.delicious.Tags::callback(ILcom/google/gwt/core/client/JavaScriptObject;)(this.id, jsonobj);
		};
...
/*
 http://feeds.delicious.com/feeds/json/tags/jldupont?callback=CALLBACK

...
"""
__long_desc = """<p>This library contains the following utilities:
<ul>
 <li>MindMeister mindmaps Backup command line: for exporting mindmaps from MindMeister in FreeMind format</li>
 <li>Delicious API</li>
